...
function Device(app, opts) {
  ...
  this.name = 'Disk@' + os.hostname() + ' (' + opts.disk_string + ') (% use)';
   ...
   setInterval(function() {
      ...
      function (error, stdout, stderr) {
        stdout.replace(/(\n|\r|\r\n)$/, '');
        self._app.log.debug('[ninja-diskspace] Disk usage for %s is at %s, update interval is %s seconds',opts.disk_string, stdout, opts.poll_interval);
